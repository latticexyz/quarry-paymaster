...
contract AllowanceTest is MudTest {
  ...
  function testGrantAllowanceBalanceDecreasesAllowanceIncreases() public {
    ...
    uint256 initialUserAllowance = AllowanceLib.getAvailableAllowance(user);
    ...
    assertEq(AllowanceLib.getAvailableAllowance(user), initialUserAllowance + allowanceAmount);
  ...
  function testRemoveAllowanceRestoresBalance() public {
    ...
    assertEq(Balance.get(sponsor1), sponsorBalance);
    assertEq(AllowanceLib.getAvailableAllowance(user), 0);
  }
  ...
  function testGrantAdditionalAllowanceFromSameSponsor() public {
    ...
    assertEq(AllowanceLib.getAvailableAllowance(user), firstAllowance + additionalAllowance);
