...
library Balance {
   ...
   * @notice Get balance.
   */
  function getBalance(address user) internal view returns (uint256 balance) {
   ...
   * @notice Get balance.
   */
  function _getBalance(address user) internal view returns (uint256 balance) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Get balance.
   */
  function get(address user) internal view returns (uint256 balance) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Get balance.
   */
  function _get(address user) internal view returns (uint256 balance) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set balance.
   */
  function setBalance(address user, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set balance.
   */
  function set(address user, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set balance.
   */
  function _set(address user, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
